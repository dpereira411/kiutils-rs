...
## [0.2.0](https://github.com/Milind220/kiutils-rs/compare/kiutils_kicad-v0.1.1...kiutils_kicad-v0.2.0) - 2026-03-02

### Fixed

- add safe project pinned-lib setters and lib-table URI upsert ([#20](https://github.com/Milind220/kiutils-rs/pull/20))

## [0.1.1](https://github.com/Milind220/kiutils-rs/compare/kiutils_kicad-v0.1.0...kiutils_kicad-v0.1.1) - 2026-02-28
...
- add mdBook guide site and Pages deploy workflow ([#14](https://github.com/Milind220/kiutils-rs/pull/14))
